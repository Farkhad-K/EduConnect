...
namespace EduConnect.Api.Data.Migrations
{
    ...
    [Migration("20250420174222_CreateAttendanceSchema")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("EduConnect.Api.Entities.Attendance", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("EduConnect.Api.Entities.TokenForTeachers", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
                    ...
                    b.ToTable("TokenForTeachers", (string)null);
                });
            ...
            modelBuilder.Entity("EduConnect.Api.Entities.Attendance", b =>
                {
                    b.HasOne("EduConnect.Api.Entities.Class", "Class")
                        .WithMany("Attendances")
                        .HasForeignKey("ClassId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("EduConnect.Api.Entities.Student", "Student")
                        .WithMany("Attendances")
